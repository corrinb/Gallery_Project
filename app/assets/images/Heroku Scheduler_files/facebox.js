    ...
    <div id="facebox" style="display:none;"> \
      <div class="popup"> \
        ...
        loading: function() {
            ...
            if ($.facebox.settings.loadingImage) $('#facebox .loading').removeClass('inline').append('<img src="' + $.facebox.settings.loadingImage + '"/>')
...
/*
   ...
   */
    ...
    function init(settings) {
        ...
        $('#facebox .close').click($.facebox.close).append('&nbsp;')
    }
